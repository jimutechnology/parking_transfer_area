...
void    CarExtractor::CalculateCarInfo()
{
    ...
    cout << "{" << mid_front_wheels.x << ", " << mid_front_wheels.y << "} " 
         << "{" << mid_rear_wheels.x << ", " << mid_rear_wheels.y << "} " << endl;
    carInfo.length_wheelbase = mid_front_wheels.distance(mid_rear_wheels) + 0.5 * wheel_length_average;
    ...
    Point       access_point = mid_front_wheels 
                             + Point(wheel_length_average * cos(carInfo.yaw), wheel_length_average * sin(carInfo.yaw));
